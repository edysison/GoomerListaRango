const restaurant = require('../../../src/services/validator/restaurant')
...
describe('Validating base function Base64', () => {
    it('Valid data', () => {
        ...
        expect(restaurant.Base64(image)).toStrictEqual({error:""})
    })
    it('Invalid data', () => {
        expect(restaurant.Base64("not an base64 image")).toStrictEqual({error:"Formato da imagem invalida"})
    })
})
...
describe('Validating base function workingdays', () => {
    ...
    it('Valid opening time', () => {
        newData = [...workingdays]
        expect(restaurant.Workingdays(newData)).toStrictEqual({error:""})
    })
    it('Invalid duplicate day', () => {
        ...
        expect(restaurant.Workingdays(newData)).toStrictEqual({error:"Apenas 1 registro por dia da semana"})
    })
